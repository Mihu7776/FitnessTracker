...
class InitialDataLoader {
    ...
    public void loadInitialData(ContextRefreshedEvent event) {
        ...
        // WERYFIKACJA NATYWNEGO SQL:
        System.out.println("Users with @gmail.com: " + userRepository.findByEmailDomain("@gmail.com").size());
        System.out.println("Users with @oracle.com: " + userRepository.findByEmailDomain("@oracle.com").size());
        System.out.println("Users with @domain.com: " + userRepository.findByEmailDomain("@domain.com").size());
